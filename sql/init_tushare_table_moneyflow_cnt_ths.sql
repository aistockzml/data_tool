...
CREATE TABLE IF NOT EXISTS `aistockzml_tushare_moneyflow_cnt_ths` (
    ...
    `PCT_CHANGE` decimal(20,6) NULL COMMENT '行业涨跌幅',
    `INDUSTRY_INDEX` decimal(20,6) NULL COMMENT '板块指数',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='同花顺概念板块资金流向（THS）表';
